		...
		<div id="page">
			...
			<div id="menuGauche">
				...
				<ul id="menuList">
					...
					<br/></li>
					<li class="smenu">
						<?php echo anchor('c_comptable/listeFiches', 'Valider fiches de frais', 'title="Consultation de mes fiches de frais"'); ?>
					<br/></li>
					<li class="smenu">
						<?php echo anchor('c_comptable/suiviFiches', 'Suivre paiement fiches de frais', 'title="Suivre paiement fiche frais"'); ?>
					<br/></li>
					<li class="smenu">
			...
			<div id="pied">
				 ...
				 <img src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid XHTML 1.0 Strict" height="31" width="88" />
